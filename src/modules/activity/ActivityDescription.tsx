...
export default function ActivityDescription({ event }: Props) {
  ...
  if (event.activity_code == "account.setting.peer.login.expiration.update")
    return <div className={"inline"}>{t("desc_account_setting_peer_login_expiration_update")}</div>;

  if (event.activity_code == "account.setting.peer.login.expiration.enable")
    return <div className={"inline"}>{t("desc_account_setting_peer_login_expiration_enable")}</div>;

  if (event.activity_code == "account.setting.peer.login.expiration.disable")
    return <div className={"inline"}>{t("desc_account_setting_peer_login_expiration_disable")}</div>;
  ...
  if (event.activity_code == "integration.create") {
    if (!event.meta.platform) return <div className={"inline"}>{t("desc_integration_create")}</div>;
    return (
      <div className={"inline"}>
  ...
  if (event.activity_code == "integration.delete") {
    if (!event.meta.platform) return <div className={"inline"}>{t("desc_integration_delete")}</div>;
    return (
      <div className={"inline"}>
  ...
  if (event.activity_code == "integration.update") {
    if (!event.meta.platform) return <div className={"inline"}>{t("desc_integration_update")}</div>;
    return (
      <div className={"inline"}>

...
function PeersTableColumns(
	...
	return [
		...
		},
		{
			...
			header: ({ column }) => {
				return (
					<DataTableHeader column={column}>{t("address")}</DataTableHeader>
				);
			},
		...
		},
		{
			...
			header: ({ column }) => {
				return (
					<DataTableHeader column={column}>{t("serialNumber")}</DataTableHeader>
				);
			},
		...
		},
		{
			...
			header: ({ column }) => {
				return (
					<DataTableHeader column={column}>{t("version")}</DataTableHeader>
				);
			},
			cell: ({ row }) => (
				<PeerVersionCell

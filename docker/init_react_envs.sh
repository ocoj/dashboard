...
# The sha256 hash changes with every Next.js build, so unsafe-inline is used\n# instead (see CSP_POLICY below).  Keep the hs-scripts domain for HubSpot.\nTHIRD_PARTY_CSP_SCRIPT_SRC=\"*.hs-scripts.com\"
